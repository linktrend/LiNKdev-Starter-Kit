...
The structure of building API's with tRPC is simple. If you want to see the rest of the code for the posts router, you can view it [here](https://github.com/antoineross/ltm-starter-kit/server/api/routers/posts.ts).
...
A new SQL file for the posts has been added. If anyone from a previous version of LTM Starter Kit wants to try it locally, they need to run [this](https://github.com/antoineross/ltm-starter-kit/blob/main/supabase/migrations/20240918141953_posts.sql) SQL file to set up the necessary database structure.
