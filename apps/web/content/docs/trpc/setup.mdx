...
export { handler as GET, handler as POST };
    ...
    ```
      ...
      This file uses a local **env.js** file to store your environment variables. So make sure to add that in your project. [Here](https://github.com/antoineross/ltm-starter-kit/blob/main/env.js) is an example of what the env file should look like. 
