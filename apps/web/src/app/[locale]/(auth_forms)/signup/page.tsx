...
export default function SignUpPage({ params: { locale } }: ConsoleLoginPageProps) {
  ...
  const handleSocialLogin = (provider: string) => {
    ...
    // Mock: Navigate to step 2 of onboarding
    setCurrentStep(2);
  };

  const handleEmailSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Mock: Send magic link and move to step 2
  ...
  // Dashboard mock login for console
  const goToConsole = () => {
