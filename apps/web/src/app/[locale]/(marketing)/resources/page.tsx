      ...
      mainContent={
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Link href="/en/resources/library" className="p-8 bg-primary/5 rounded-lg border-2 border-primary/20 hover:border-primary/40 transition-colors">
            ...
            <Link href="/en/resources/for-customers" className="p-8 bg-muted/30 rounded-lg border hover:border-primary/40 transition-colors">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="p-6 bg-background rounded-lg border">
                ...
                <Link href="/en/docs" className="text-primary hover:underline text-sm font-medium">
                  View Docs →
                </Link>
              </div>
              ...
              <div className="p-6 bg-background rounded-lg border">
                ...
                <Link href="/en/resources/library#tutorials" className="text-primary hover:underline text-sm font-medium">
                  Browse Tutorials →
                </Link>
              </div>
              ...
              <div className="p-6 bg-background rounded-lg border">
                ...
                <Link href="/en/resources/library#best-practices" className="text-primary hover:underline text-sm font-medium">
                  Read Guides →
                </Link>
              </div>
              ...
              <div className="p-6 bg-background rounded-lg border">
                ...
                <Link href="/en/resources/library#case-studies" className="text-primary hover:underline text-sm font-medium">
                  View Case Studies →
                </Link>
              </div>
              ...
              <div className="p-6 bg-background rounded-lg border">
                ...
                <Link href="/en/resources/library#events" className="text-primary hover:underline text-sm font-medium">
                  View Schedule →
                </Link>
              </div>
              ...
              <div className="p-6 bg-background rounded-lg border">
                ...
                <Link href="/en/help-center" className="text-primary hover:underline text-sm font-medium">
                  Get Help →
                </Link>
              </div>
            </div>
