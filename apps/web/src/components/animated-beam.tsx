  ...
  whatsapp: () => (
    ...
    >
      <defs>
        ...
        >
          <stop offset="0" stopColor="hsl(var(--color-success))" />
          <stop offset="1" stopColor="hsl(var(--color-success))" />
        </linearGradient>
        <filter
          id="a"
          width="1.115"
    ...
    >
      <defs>
        ...
        <linearGradient
          ...
          id="linearGradient-5"
        >
          <stop stopColor="hsl(var(--color-primary))" stopOpacity="0.2" offset="0%" />
          <stop stopColor="hsl(var(--color-primary))" stopOpacity="0.02" offset="100%" />
        </linearGradient>
        <path
          d="M29.375,0 L4.40625,0 C1.9828125,0 0,1.99431818 0,4.43181818 L0,60.5681818 C0,63.0056818 1.9828125,65 4.40625,65 L42.59375,65 C45.0171875,65 47,63.0056818 47,60.5681818 L47,17.7272727 L29.375,0 Z"
          id="path-6"
        ...
        >
          <stop stopColor="hsl(var(--color-background))" stopOpacity="0.1" offset="0%" />
          <stop stopColor="hsl(var(--color-background))" stopOpacity="0" offset="100%" />
        </radialGradient>
      </defs>
      <g
        id="Page-1"
  ...
  zapier: () => (
    ...
    >
      ...
      <path
        ...
        fill="hsl(var(--color-foreground))"
      />
      <path d="M39.0441 45.2253H0V54.789H39.0441V45.2253Z" fill="hsl(var(--color-danger))" />
    </svg>
  ),
  messenger: () => (
    <svg
    ...
    >
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0" stopColor="hsl(var(--color-primary))"></stop>
        <stop offset=".079" stopColor="hsl(var(--color-primary))"></stop>
        <stop offset=".23" stopColor="hsl(var(--color-primary))"></stop>
        <stop offset=".351" stopColor="hsl(var(--color-primary))"></stop>
        <stop offset=".428" stopColor="hsl(var(--color-primary))"></stop>
        <stop offset=".754" stopColor="hsl(var(--color-danger))"></stop>
        <stop offset=".946" stopColor="hsl(var(--color-danger))"></stop>
      </radialGradient>
      <path
